...
public class StatusBarUtil {
    ...
    private static final boolean isNavigationBar = false;//底部导航栏是否透明
    ...
    /**
     * 使状态栏透明 -- Tomleisen
     * FitScreenUitls.setWindow
     */
    public static void setTransparentWindow(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    public static int getStatusBarHeight(Context context) {
        boolean isHuaWei = FitScreenUitls.hasNotchInScreen(context);
        Log.e("isHuaWeiPhone~", isHuaWei + "");
        if (isHuaWei) {
            return FitScreenUitls.getNotchSize(context)[1];
        } else {
            // 获得状态栏高度
     ...
     * @param view
     */
    public static void setLayoutParams(Activity context,View view){
        setHiddenStatusBar(context);
        ...
        linearParams.height = getStatusBarHeight(context);// 控件的宽强制设成30
